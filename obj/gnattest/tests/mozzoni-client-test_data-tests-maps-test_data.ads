...
package Mozzoni.Client.Test_Data.Tests.Maps.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Mozzoni.Client.Maps.Test_Data (Test);
...
end Mozzoni.Client.Test_Data.Tests.Maps.Test_Data;
