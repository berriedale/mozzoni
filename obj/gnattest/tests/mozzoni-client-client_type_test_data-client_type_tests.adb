...
--  begin read only
   ...
   procedure Test_Read_Available_f0f5bd (Gnattest_T : in out Test_Client_Type) renames Test_Read_Available;
--  id:2.2/f0f5bdfe92553b15/Read_Available/1/0/
   procedure Test_Read_Available (Gnattest_T : in out Test_Client_Type) is
   --  mozzoni-client.ads:25:4:Read_Available
--  end read only
...
--  id:2.2/bc4703174166b521/Client_For/1/0/
   ...
   --  mozzoni-client.ads:37:4:Client_For
--  end read only
...
--  id:2.2/280f2c7eee8955be/Client_For/0/0/
   ...
   --  mozzoni-client.ads:38:4:Client_For
--  end read only
